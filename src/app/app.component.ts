...
export class AppComponent implements  OnInit {
  ...
  getEmployees() {
    return this.http.get<IEmployee[]>(`${environment.apiUrl}/Crud`);
  }

  deleteEmployee(d) {
    return this.http.delete<IStatus>(`${environment.apiUrl}/Crud/${d}`);
  }
...
export class AddEmpDialogComponent {
  constructor(
    ...
    // Method
  updateEmployee(d) {
    return this.http.put<IStatus>(`${environment.apiUrl}/Crud/${d.EmployeeID}`, d);
  }

  addEmployee(d) {
    return this.http.post<IStatus>(`${environment.apiUrl}/Crud`, d);
  }
